...
func (test *TestRun) TheOutputContains(arg string) error {
	if !strings.Contains(fmt.Sprintf("%s", string(test.Output)), arg) {
...
func (test *TestRun) TheOutputContainsAnd(arg1, arg2 string) error {
	if !strings.Contains(fmt.Sprintf("%s", string(test.Output)), arg1) && strings.Contains(fmt.Sprintf("%s", string(test.Output)), arg2) {
